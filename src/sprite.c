...
const int ANIM_IMAGE_RESOURCE_IDS[] = {
  ...
  RESOURCE_ID_FRAME_5
     ...
     /* // Egg
  RESOURCE_ID_BFRAME_0, 
  RESOURCE_ID_BFRAME_1,
  RESOURCE_ID_BFRAME_2,
  RESOURCE_ID_BFRAME_3,
  RESOURCE_ID_BFRAME_4,
  RESOURCE_ID_BFRAME_5
      */
    /*
  RESOURCE_ID_EFRAME_0, 
  RESOURCE_ID_EFRAME_1,
  RESOURCE_ID_EFRAME_2,
  RESOURCE_ID_EFRAME_3,
  RESOURCE_ID_EFRAME_4,
  RESOURCE_ID_EFRAME_5
      */
    /*
  RESOURCE_ID_ESWAB_0, 
  RESOURCE_ID_ESWAB_1,
